...
useEffect(() => async() => {
  ...
  try {
    const redirectToken = await axios('http://61.74.187.4:7100/?jwt=eyJhbGciOiJIUzI1NiIsImV4cCI6MTY1ODEzMzAyNTU4Nn0.eyJlbWFpbCI6ImFAYS5jb20iLCJuYW1lIjoiYSJ9.oiSjwUovICOu8edDxueq6RJ_1K-MaKjZJi-fdjUDPkw');
